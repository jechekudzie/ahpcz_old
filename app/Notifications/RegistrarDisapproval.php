...
class RegistrarDisapproval extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('New application has been disapproved by Registrar, view the application\'s comments section for more details')
