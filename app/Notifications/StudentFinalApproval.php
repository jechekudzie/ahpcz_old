...
class StudentFinalApproval extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Student Registration application has been approved and signed off by the registrar, you can process your certificates.')
