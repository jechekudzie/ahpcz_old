...
class StudentRegistrationsAproval extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('Student Application - ' . $this->practitioner->first_name.' '.$this->practitioner->last_name)
            ->line('Student Registration application has been approved by registration office, now awaiting your review and approval:')
