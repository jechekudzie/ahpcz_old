            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add practitioner employer</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-12">
                                <div class="card wizard-content">
                                    <div class="card-body">
                                        ...
                                        <form action="/admin/practitioners/employer/{{$practitioner->id}}/store"
                                              method="post" id="">
                                            {{csrf_field()}}
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               id="" name="business_address" value="{{old('business_address')}}" >
                                                    </div>
                                                    <div class="form-group">
