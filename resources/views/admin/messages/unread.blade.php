                        ...
                        <div class="col-xlg-2 col-lg-3 col-md-4">
                            <div class="card-body inbox-panel"><a href="{{url('/admin/notification/compose')}}"
                                ...
                                <ul class="list-group list-group-full">
                                    <li class="list-group-item"><a href="{{url('/admin/notification/unread')}}"><i
                                                class="mdi mdi-gmail"></i> Unread </a><span
                                            class="badge badge-success ml-auto">{{count(auth()->user()->unreadNotifications)}}</span>
                                    </li>
                                ...
                                <div class="card b-all shadow-none">
                                    <div class="inbox-center table-responsive">
                                        <table class="table table-hover no-wrap">
                                            <tbody>
                                            @foreach (auth()->user()->unreadNotifications()->paginate(10) as $userNotification)
                                                <tr style="color: {{$userNotification->read_at == null ? 'blue':'black' }}">
                                                    ...
                                                    <td class="max-texts"><a href="/admin/{{$userNotification->id}}/read"/><span
                                                            class="label label-info m-r-10">Work</span>
