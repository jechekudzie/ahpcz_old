                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">{{$prefix->name}} fee of {{$prefix->fee}} </h4>
                                <h6 class="card-subtitle">Delete {{$prefix->name}} </h6>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <form action="/admin/prefixes/{{$prefix->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                                        <h5><span class="text-danger">Are you sure you want to delete {{$prefix->name}} ?</span></h5>
