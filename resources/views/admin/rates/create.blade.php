...
@section('title','AHPCZ - Create Rate')
@section('plugins-css')
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/renewal_fees" class="btn btn-success">All Rates</a>
...
--}}
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/rates" method="post" class="m-t-40" novalidate>
                                    {{csrf_field()}}

                                    <div class="form-group">
                                        <h5>Base Currency/Target Currency <span class="text-danger">*</span></h5>
                                        <div class="controls">
