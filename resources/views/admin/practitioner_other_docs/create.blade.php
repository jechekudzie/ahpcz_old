    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/practitioners/{{$otherApplication->id}}" class="btn btn-success"></i> Dash Board</a>
            </div>
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Application documents</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-12">
                                <div class="card wizard-content">
                                    <div class="card-body">
                                        ...
                                        <form action="/admin/practitioners/docs/{{$otherApplication->id}}/store"
