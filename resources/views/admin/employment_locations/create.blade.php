...
@section('title','AHPCZ - Create Location')
@section('plugins-css')
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/renewal_categories" class="btn btn-success"> All Locations</a>
...
{{--
                                    <h6 class="card-subtitle">A Location is the practitioner's area of practice.</h6>
--}}
                            </div>
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/employment_locations" method="post" class="m-t-40" novalidate>
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-feedback">
                                            <small>Location name is <code>mandatory</code>.
                                            </small>
                                        </div>
                                    </div>
