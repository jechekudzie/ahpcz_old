        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Profession</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            @endif
                            <h4 class="card-title">Edit {{$profession->name}} Profession</h4>
                            <h6 class="card-subtitle">Update {{$profession->name}} profession</h6>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-8">
                            <form action="/admin/professions/{{$profession->id}}" method="post" class="m-t-40" novalidate>
                                {{method_field('PATCH')}}
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                            <textarea name="description" class="form-control" required
                                                      data-validation-required-message="This field is required">{{$profession->description}}{{old('description')}}</textarea>
                                    </div>
                                    <div class="form-control-feedback">
                                        <small>Description of the profession helps to understand more and it is
                                            <code>mandatory</code>.
                                        </small>
                                    </div>
