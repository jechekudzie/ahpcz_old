    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/practitioners/{{$practitionerQualification->practitioner->id}}" class="btn btn-success"></i> Dash Board</a>
            </div>
                            ...
                            <div class="col-12">
                                <div class="card wizard-content">
                                    <div class="card-body">
                                        ...
                                        <form action="/admin/practitioners/qualifications/{{$practitionerQualification->id}}/update"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select form-control " required
                                                            ...
                                                            @foreach($professions as $profession)
                                                                <option value="{{$profession->id}}" @if($profession->id==$practitionerQualification->profession_id){{'selected'}}@endif>{{$profession->name}}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select form-control" required
                                                            ...
                                                            @foreach($qualification_categories as $qualification_category)
                                                                <option value="{{$qualification_category->id}}" @if($qualification_category->id==$practitionerQualification->qualification_category_id){{'selected'}}@endif>{{$qualification_category->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <div class="form-control-feedback">
                                                ...
                                                <input type="hidden" id="pq_id" value="{{$practitionerQualification->professional_qualification_id}}">

                                                <input type="hidden" id="accreInst_id" value="{{$practitionerQualification->accredited_institution_id}}">

                                                <input type="hidden" id="checkqualcategory"  value="{{$practitionerQualification->qualification_category_id}}">
                                                ...
                                                <div id="institution_div" style="display: none;" class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               name="institution" value="{{$practitionerQualification->institution}}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="commencement_date" value="{{$practitionerQualification->commencement_date}}" class="form-control" id="commencement_date">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="completion_date" value="{{$practitionerQualification->completion_date}}" class="form-control" id="completion_date">
                                                    </div>
                                                </div>
