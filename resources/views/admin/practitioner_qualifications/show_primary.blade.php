...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            ...
            @endcan
            <a href="/admin/practitioners/{{$practitioner->id}}"
                        ...
                        <div class="col-12">
                            <div class="card wizard-content">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title">{{$practitioner->professionalQualification->name}}</h5>
                                                ...
                                                <ul class="dot-list">
                                                    <div class="row">
                                                        <div class="col-md-3 col-xs-6 b-r"><strong>Profession
                                                            ...
                                                            <br>
                                                            <p class="text-muted">{{ucwords($practitioner->profession->name)}}</p>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 b-r"><strong>Profession
                                                                Qualification
                                                            </strong>
                                                            <br>
                                                            <p class="text-muted">{{ucwords($practitioner->professionalQualification->name)}}</p>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 col-xs-6 b-r"><strong>Accredited
                                                            ...
                                                            <p class="text-muted">{{ucwords($practitioner->accreditedInstitution->name)}}</p>
                                                            @else
                                                            <p class="text-muted">{{ucwords($practitioner->institution)}}</p>
                                                        ...
                                                        <div class="col-md-3 col-xs-6 b-r"><strong>Qualification
                                                            ...
                                                            <br>
                                                            <p class="text-muted">{{ucwords($practitioner->qualificationCategory->name)}}</p>
                                                        </div>
                                                        <div class="col-md-3 col-xs-6 b-r">
                                                            <strong>Commencement date</strong>
                                                            <br>
                                                            <p class="text-muted">{{ date("d F Y", strtotime($practitioner->commencement_date)) }}</p>
                                                        </div>

                                                        <div class="col-md-3 col-xs-6 b-r">
                                                            <strong>Completion date</strong>
                                                            <br>
                                                            <p class="text-muted">{{ date("d F Y", strtotime($practitioner->completion_date)) }}</p>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <a href="/admin/practitioners/qualifications/{{$practitioner->id}}/editprimary"
