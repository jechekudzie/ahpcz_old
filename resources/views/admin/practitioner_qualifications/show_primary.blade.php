                                                    ...
                                                    <ul class="dot-list">
                                                        <div class="row">
                                                            <div class="col-md-3 col-xs-6 b-r"><strong>Profession
                                                                ...
                                                                <p class="text-muted">
                                                                    @if($practitioner->profession)
                                                                        {{ucwords($practitioner->profession->name)}}
                                                                    @endif
                                                                </p>
                                                            </div>
                                                            <div class="col-md-3 col-xs-6 b-r"><strong>Profession
                                                                ...
                                                                <p class="text-muted">
                                                                    @if($practitioner->professionalQualification)
                                                                        {{ucwords($practitioner->professionalQualification->name)}}
                                                                    @endif
                                                                </p>
                                                            </div>
                                                                ...
                                                                @if($practitioner->qualification_category_id == 1)
                                                                    <p class="text-muted">
                                                                        @if($practitioner->accreditedInstitution)
                                                                            {{ucwords($practitioner->accreditedInstitution->name)}}
                                                                        @endif
                                                                    </p>
                                                                @else
                                                            ...
                                                            <div class="col-md-3 col-xs-6 b-r"><strong>Qualification
                                                                ...
                                                                <br>
                                                                <p class="text-muted">
                                                                    @if($practitioner->qualificationCategory)
                                                                        {{ucwords($practitioner->qualificationCategory->name)}}
                                                                    @endif
                                                                </p>
                                                            </div>
