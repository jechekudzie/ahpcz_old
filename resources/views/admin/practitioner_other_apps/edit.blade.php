    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                @endcan
                <a href="/admin/practitioners/{{$otherApplication->practitioner->id}}" class="btn btn-success"></i> Dash Board</a>
            </div>
                            ...
                            <div class="col-12">
                                <div class="card wizard-content">
                                    <div class="card-body">
                                        ...
                                        <form action="/admin/practitioners/apps/{{$otherApplication->id}}/update"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="wlocation2"> Application forms : <span
                                                                    class="danger">*</span>
                                                        </label>
                                                        <select name="payment_item_id"
                                                                class="select2 form-control custom-select"
                                                                style="width: 100%; height:36px;">
                                                            <option>Choose application form</option>
                                                            <optgroup label="Application form">
                                                                @foreach($payment_items as $payment_item)
                                                                    <option value="{{$payment_item->id}}" @if($payment_item->id == $otherApplication->payment_item_id){{'selected'}}@endif>{{$payment_item->name}}</option>
                                                                @endforeach
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="application_date" class="form-control"
                                                               id="commencement_date"  value="{{$otherApplication->application_date}}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="submit" value="Update Application" name="add"
