            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <br/>
                        <div class="col-md-8">
                            <h3>By clicking "Delete Practitioner" you are confirming deletion. This action cannot be
                                reversed.</h3>
                            <form method="post" action="{{url('/admin/practitioners/'.$practitioner->id)}}">
                                {{method_field("DELETE")}}
                                {{csrf_field()}}
