            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        {{--<li class="breadcrumb-item active">{{$accreditation->profession->name}} </li>--}}
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <form action="/admin/accredited_qualifications/{{$accreditation->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                                        <h5><span class="text-danger">Are you sure you want to delete <strong style="color: black;">{{$accreditation->professionalQualification->name}}</strong>  ?</span></h5>
