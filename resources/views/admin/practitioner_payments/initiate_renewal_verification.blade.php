                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-4">
                                    <form action="{{url('/admin/practitioner_renewals/'.$renewal->id.'/verify_renewal')}}" method="post" class="m-t-40" novalidate>
                                        {{csrf_field()}}
                                        <h5><span class="text-danger">Very renewal for {{$practitioner->first_name.' '.$practitioner->last_name}} ?</span>
                                        </h5>
