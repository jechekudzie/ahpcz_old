                                                ...
                                                <div class="d-flex no-block align-items-center">
                                                    ...
                                                    <div class="ml-auto">
                                                        @if($practitioner->payments)
                                                            <h2 class="counter text-purple">{{$practitioner->payments->sum('balance')}}</h2>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table id="subscriptions"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($balances as $balance)
                                                            <tr>
                                                                <td>{{$balance->renewal_period_id}}</td>
                                                                <td>{{$balance->paymentItemCategory->name}}</td>
                                                                <td>{{$balance->paymentItem->name}}</td>
                                                                <td>{{$balance->amount_invoiced}}</td>
                                                                <td>{{$balance->amount_paid}}</td>
                                                                <td>{{$balance->balance}}</td>
                                                                <td>{{$balance->paymentChannel->name}}</td>
                                                                <td>{{$balance->receipt_number}}</td>
                                                                <td>{{date("d M Y", strtotime( $balance->payment_date))}}</td>
                                                            </tr>
                                                        @endforeach
