    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                @endcan
                <a href="/admin/students/{{$practitioner->id}}" class="btn btn-success"> Dashboard</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                @if(auth()->user()->role_id == 4)
                                    ...
                                    <form action="/admin/students/approval/{{$practitioner->id}}/officer"
                                ...
                                @if(auth()->user()->role_id == 5)
                                    @if($practitioner->registration_officer == 2 && $practitioner->accountant == 0
                                        ...
                                        <form action="/admin/students/approval/{{$practitioner->id}}/final_payment"
                                              method="post"
                                    ...
                                    @else
                                        ...
                                        <form action="/admin/students/approval/{{$practitioner->id}}/accountant"
                                              method="post"
                                              class="m-t-40" novalidate>
                                            {{csrf_field()}}
                                            <div class="form-group">
                                    ...
                                    @if(auth()->user()->role_id == 6)
                                        ...
                                        <form action="/admin/students/approval/{{$practitioner->id}}/member"
                                              method="post"
                                              class="m-t-40" novalidate>
                                            {{csrf_field()}}
                                            <div class="form-group">
                                    ...
                                    @if(auth()->user()->role_id == 7)
                                        ...
                                        <form action="/admin/students/approval/{{$practitioner->id}}/registrar"
                                              method="post" class="m-t-40" novalidate>
                                            {{csrf_field()}}
                                            <div class="form-group">
                                                <h5>Comments <span class="text-danger">*</span></h5>
