...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            ...
            <a href="/admin/nationalities/{{$nationality->id}}" class="btn btn-success"></i> All Nationalities</a>
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit {{$nationality->name}}</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <h6 class="card-subtitle">Update {{$nationality->name}} </h6>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-8">
                            <form action="/admin/nationalities/{{$nationality->id}}" method="post" class="m-t-40" novalidate>
                                {{method_field('PATCH')}}
                                {{csrf_field()}}
                                <div class="form-group">
                                    <h5>Country Code <span class="text-danger">*</span></h5>
                                    <div class="controls">
                                        <input type="text" name="code" value="{{$nationality->code}}" class="form-control"
                                               required
