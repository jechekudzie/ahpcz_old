            ...
            <div class="col-md-12">
                <div class="card">
                        ...
                        <h4>Registration Number :
                            @if($practitioner->registration_number == null)
                                {{$practitioner->prefix.' (No Registration Number)'}} <a
                                    href="/admin/students/generate_reg/{{$practitioner->profession_id}}/{{$practitioner
                                    ->id}}">Generate</a>
                            @else
                    ...
                    <div class="row">
                        ...
                        <br/>
                        <div class="col-md-8">
                            <h3>By clicking "Delete Student" you are confirming deletion. This action cannot be
                                reversed.</h3>
                            <form method="post" action="{{url('/admin/students/'.$practitioner->id)}}/destroy">
                                {{method_field("DELETE")}}
                                {{csrf_field()}}
