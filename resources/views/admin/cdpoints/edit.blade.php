            ...
            <div class="col-md-4 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{$cdpoint->profession->name}} > {{$cdpoint->points}}</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">Edit {{$cdpoint->points}} </h4>
                                {{--
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/cdpoints/{{$cdpoint->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
                                        ...
                                        <div class="controls">
                                            <select name="profession_id" id="select" required class="form-control selectpicker" data-live-search="true">
                                                ...
                                                @foreach($professions as $profession)
                                                    <option value="{{$profession->id}}" @if ($profession->id == $cdpoint->profession_id) {{ 'selected' }} @endif >{{$profession->name}}</option>
                                                @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="points" value="{{$cdpoint->points}}" class="form-control"
                                                   required
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <input type="submit" name="update_points"
                                                   class="btn btn-rounded btn btn-block btn-success"
                                                   value="Update CPD Points & Placement">
                                        </div>
