            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Create New Register Category</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">Create New Register Category</h4>
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/register_categories" method="post" class="m-t-40" novalidate>
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <input type="submit" name="add_profession"
                                                   ...
                                                   value="Create New Register Category">
                                        </div>
