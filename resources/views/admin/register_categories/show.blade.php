            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{$registerCategory->name}} </li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">{{$registerCategory->name}}  </h4>
                                <h6 class="card-subtitle">Delete {{$registerCategory->name}}</h6>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <form action="/admin/register_categories/{{$registerCategory->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                                        <h5><span class="text-danger">Are you sure you want to delete {{$registerCategory->name}} ?</span></h5>
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <input type="submit" name="add_profession"
                                                   ...
                                                   value="Yes Delete Register Category">
                                        </div>
