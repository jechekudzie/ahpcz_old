    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/practitioners/{{$practitionerExperience->practitioner->id}}" class="btn btn-success"></i> Dash Board</a>
            </div>
                            ...
                            <div class="col-12">
                                <div class="card wizard-content">
                                    <div class="card-body">
                                        ...
                                        <form action="/admin/practitioners/experience/{{$practitionerExperience->id}}/update"
                                              method="post" id="">
                                            {{method_field('PATCH')}}
                                            {{csrf_field()}}
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               name="name" value="{{$practitionerExperience->name}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="wphoneNumber2">Email
                                                            :</label>
                                                        <input type="text" class="form-control"
                                                               id="" value="{{$practitionerExperience->email}}"
                                                               name="email">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="wphoneNumber2">Phone
                                                            :</label>
                                                        <input type="text" class="form-control"
                                                               id="" value="{{$practitionerExperience->phone}}"
                                                               name="phone">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="wphoneNumber2">Job title
                                                            :</label>
                                                        <input type="text" class="form-control"
                                                               id="" value="{{$practitionerExperience->job_title}}"
                                                               name="job_title">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="business_address" value="{{$practitionerExperience->business_address}}"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="wphoneNumber2">Contact Person
                                                            :</label>
                                                        <input type="text" class="form-control"
                                                               id="" value="{{$practitionerExperience->contact_person}}"
                                                               name="contact_person">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Commencement Date</label>
                                                        <input type="text" name="commencement_date" value="{{$practitionerExperience->commencement_date}}" class="form-control" id="commencement_date">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Resignation Date</label>
                                                        <input type="text" name="resignation_date" value="{{$practitionerExperience->commencement_date}}" class="form-control" id="resignation_date">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select form-control" required
                                                            ...
                                                            @foreach($provinces as $province)
                                                                <option value="{{$province->id}}" @if($province->id ==$practitionerExperience->province_id){{'selected'}}@endif>{{$province->name}}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <input type="hidden" name="my_id" id="my_id" value="{{$practitionerExperience->city_id}}">
