    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/accredited_institutions" class="btn btn-success"></i> All Professions Qualifications</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/professional_qualifications/{{$professionalQualification->id}}" method="post" class="m-t-40"
                                      novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="profession_id" id="select" required
                                                    class="form-control selectpicker" data-live-search="true">
                                                <option value="">Choose Professions</option>
                                                @foreach($professions as $profession)
                                                    <option value="{{$profession->id}}" @if($profession->id ==$professionalQualification->profession_id){{'selected'}}@endif>{{$profession->name}}</option>
                                                @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" value="{{$professionalQualification->name}}" class="form-control"
                                                   required
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <input type="submit" name="add_profession"
                                                   ...
                                                   value="Update Professional Qualification">
                                        </div>
