            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{$operationalStatus->name}} </li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">{{$operationalStatus->name}}  </h4>
                                <h6 class="card-subtitle">Delete {{$operationalStatus->name}}</h6>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <form action="/admin/operational_statuses/{{$operationalStatus->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                                        <h5><span class="text-danger">Are you sure you want to delete {{$operationalStatus->name}} ?</span></h5>
