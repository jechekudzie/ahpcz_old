                            ...
                            <div class="col-12">
                                <div class="card wizard-content">
                                    <div class="card-body">
                                        ...
                                        <p style="color: red;">Update the following details</p>

                                        <form action="/admin/practitioner_payment_info/{{$practitioner->id}}/store"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select form-control"
                                                            ...
                                                            @foreach($renewal_categories as $renewal_category)
                                                                <option value="{{$renewal_category->id}}">
                                                        ...
                                                        <select class="custom-select form-control"
                                                            ...
                                                            @foreach($register_categories as $register_category)
                                                                ...
                                                                @if($practitioner->practitioner_payment_information)
                                                                    @if($practitioner->practitioner_payment_information->register_category_id == $register_category->id)
                                                                        {{'selected'}}
                                                                        @endif
                                                                    @endif>
