                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">{{$registrationFee->qualificationCategory->name}} fee of {{$registrationFee->fee}} </h4>
                                <h6 class="card-subtitle">Delete {{$registrationFee->qualificationCategory->name}} fee of {{$registrationFee->fee}} </h6>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <form action="/admin/registration_fees/{{$registrationFee->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                                        <h5><span class="text-danger">Are you sure you want to delete {{$registrationFee->qualificationCategory->name}} ?</span></h5>
