            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Registration Fee</li>
                    </ol>
                </div>
            </div>
        </div>
...
--}}
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/registration_fees" method="post" class="m-t-40" novalidate>
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" name="fee" value="{{old('fee')}}" class="form-control"
                                                   required
