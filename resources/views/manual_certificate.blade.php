...
<div style="width: 100%; border: 5px solid green; padding: 10px;">
    <div style="display:none;background-image:url('logo/back.png');background-size: contain;background-position: center;
        background-repeat:
    no-repeat; border: 2px dashed green; padding: 0 2% 6.12442rem">
        <h6 style="display:none;text-align: right;"><span style="color: red">AHPCZ</span>{{substr
        ($renewal->renewal_period_id, -2)}}/{{str_pad($renewal->certificate_number, 4, '0', STR_PAD_LEFT)}}</h6>
        <div style="display:none;text-align: center;">
            <img style="margin-top: -40px" height="120px" src="logo/logo.png">
        </div>
        <h5 style="display:none;text-align:center;font-size: 15pt; color: black;font-weight: bolder;">ALLIED HEALTH PRACTITIONERS
            COUNCIL OF ZIMBABWE</h5>
        <p style="display:none;text-align: center;font-size: 15px; margin-top: -25px;">Number 20 Worcester Road, Eastlea, Harare.
            Phone +263 242 747282/3, +263 771 056 413</p>
        <p style="display:none;text-align: center;font-size: 15px; margin-top: -10px;">Email: <a
                href="mailto: registrations@ahpcz.co.zw">registrations@ahpcz.co.zw</a>, Website: <a
                href="www.ahpcz.co.zw">www.ahpcz.co.zw</a></p>
        <h3 style="display:none;text-align: center;">Health Professions Act</h3>
        <h3 style="display:none;text-align: center;margin-top: -14px;">(Chapter 27:19)</h3>
        <h1 style="display:none;text-align: center;margin-top: 40px;">PRACTISING CERTIFICATE</h1>
