...
<div style="border-radius: 20px; border: 2px solid green ; padding: 10px;">
    <div style="background-image:url({{ asset('logo/back.png')}});background-size: contain;background-position: center;background-repeat:no-repeat; ">
        <div style="margin-top: 10px">
            <img style="padding-left:25px;text-align:left; margin-top: 5px" height="80px"
                 src="{{asset('logo/logo.png')}}">
            <img style="padding-left:300px; text-align:right; margin-top: 5px" height="80px"
                 src="{{asset('logo/icon.png')}}">
        </div>
        <h5 style="text-align:center;font-size: 10pt; color: black;font-weight: bolder;margin-top: -10px">ALLIED HEALTH PRACTITIONERS COUNCIL OF ZIMBABWE</h5>
