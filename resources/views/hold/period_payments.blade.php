                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card wizard-content">
                                    <div class="col-md-4">
                                        <a href="/admin/practitioners/renewals/{{$renewal->id}}/create_payment"
                                           class="btn btn-success"><i class="fa fa-money"></i> Make Payment</a>

                                    </div>
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">{{$renewal->renewal_period}} Payments</h4>
