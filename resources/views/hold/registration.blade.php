                            ...
                            <div class="col-12">
                                <div class="card wizard-content">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Registration fee: ${{$registration_fee->fee}}</h4>
                                        @if($practitioner->payment_method_id == null && $practitioner->renewal_category_id ==null)
                                            <form action="/admin/practitioners/payment_requirement/{{$practitioner->id}}/payments"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="submit" name="add" value="Update Payment Requirements"
