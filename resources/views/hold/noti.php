                                            ...
                                            <table id="subscriptions"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{'New Application, Pending Accountant Approval'}}
                                                        @elseif(
                                                        ...
                                                        {{'Accountant approved, Pending Registration Officer Approval'}}
                                                        ...
                                                        {{'Registration Officer Approved, Pending Member Approval'}}
                                                        @elseif(
                                                        ...
                                                        {{'Committee Member Approved, Pending Registrar Approval '}}
                                                        @else
                                                        {{'Application has been approved, certificate should be ready for collection'}}
                                                        @endif
                                                    </td>
                                                    <td>{{ getDifference($application->created_at,now()) }}
                                                        ago
